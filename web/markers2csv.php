...
foreach ($files as  $x) {
$contatore++;
if (($contatore%10==0 && $contatore < 3430 ) ||  ($contatore%5==0 && $contatore >=3430 && $contatore<3700) || ( $contatore%2==0 && $contatore>=3700 &&  $contatore<3736) || ($contatore%10==0 && $contatore >= 3736) ) {
 $cont_pagg++;
